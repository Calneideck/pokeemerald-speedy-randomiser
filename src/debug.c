...
static const struct DebugMenuOption sDebugMenu_Actions_Main[] =
{
    ...
    { COMPOUND_STRING("Trainers…"),     DebugAction_OpenSubMenuTrainers },
    { COMPOUND_STRING("Encounters…"),   DebugAction_OpenSubMenu, sDebugMenu_Actions_Encounters, },
    { COMPOUND_STRING("Flags & Vars…"), DebugAction_OpenSubMenuFlagsVars },
...
static void DebugAction_Give_Pokemon_SelectLevel(u8 taskId)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        {
            PlaySE(MUS_LEVEL_UP);
            ScriptGiveMon(sDebugMonData->species, gTasks[taskId].tInput, ITEM_NONE, FALSE);
...
{
    ZeroPlayerPartyMons();
    CreateNPCTrainerPartyFromTrainer(gParties[B_TRAINER_PLAYER], &sDebugTrainers[DIFFICULTY_NORMAL][DEBUG_TRAINER_PLAYER], TRUE, BATTLE_TYPE_TRAINER, TRAINER_PLAYER);
    ScriptContext_Enable();
    Debug_DestroyMenu_Full(taskId);
}
...
static void DebugAction_Party_BattleSingle(u8 taskId)
{
    ...
    ZeroEnemyPartyMons();
    CreateNPCTrainerPartyFromTrainer(gParties[B_TRAINER_PLAYER], &sDebugTrainers[DIFFICULTY_NORMAL][DEBUG_TRAINER_PLAYER], TRUE, BATTLE_TYPE_TRAINER, TRAINER_PLAYER);
    CreateNPCTrainerPartyFromTrainer(gParties[B_TRAINER_OPPONENT_A], GetDebugAiTrainer(), FALSE, BATTLE_TYPE_TRAINER, TRAINER_PLAYER);
