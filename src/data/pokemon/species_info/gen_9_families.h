...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_PAWMOT}),
    },
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_MAUSHOLD_FOUR},
                                {EVO_LEVEL, 25, SPECIES_MAUSHOLD_THREE}),
    },
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LINKING_CORD, SPECIES_ARMAROUGE},
                                {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_CERULEDGE}),
    },
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_BRAMBLEGHAST}),
    },
    ...
    [SPECIES_GIMMIGHOUL_CHEST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_GHOLDENGO}),
    },
    ...
    [SPECIES_GIMMIGHOUL_ROAMING] =
    {
        ...
        .teachableLearnset = sGimmighoulTeachableLearnset,
        .formSpeciesIdTable = sGimmighoulFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_GHOLDENGO}),
        .randomizerMode = MON_RANDOMIZER_INVALID,
    },
    ...
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LINKING_CORD, SPECIES_SINISTCHA_UNREMARKABLE}),
    ...
    [SPECIES_POLTCHAGEIST_ARTISAN] =
    {
        ...
        .levelUpLearnset = sPoltchageistLevelUpLearnset,
        .teachableLearnset = sPoltchageistTeachableLearnset,
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LINKING_CORD, SPECIES_SINISTCHA_MASTERPIECE}),
        .formSpeciesIdTable = sPoltchageistFormSpeciesIdTable,
    },
