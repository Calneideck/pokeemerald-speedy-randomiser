...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_TOGETIC}),
    },
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_SUDOWOODO}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_AMBIPOM}),
    #endif
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset, rzMode)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_FARIGIRAF}),
    #endif
    },
    ...
    #if P_GEN_9_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_DUDUNSPARCE_TWO_SEGMENT},
                                {EVO_LEVEL, 33, SPECIES_DUDUNSPARCE_THREE_SEGMENT}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GLISCOR}),
    #endif
    },
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .formSpeciesIdTable = sQwilfishFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_OVERQWIL}),
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LINKING_CORD, SPECIES_WEAVILE}),
    #endif
    },
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .formSpeciesIdTable = sSneaselFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LINKING_CORD, SPECIES_SNEASLER}),
    },
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 46, SPECIES_URSALUNA}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_MAMOSWINE}),
    #endif
    },
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MANTINE}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    #if P_GEN_8_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_WYRDEER}),
    #endif
    },
