...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_SWOOBAT}),
    },
    ...
    [SPECIES_SWADLOON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_LEAVANNY}),
    },
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED] =
    {
        ...
        .formSpeciesIdTable = sBasculinFormSpeciesIdTable,
        .randomizerMode = MON_RANDOMIZER_INVALID,
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_BASCULEGION_M},
                                {EVO_LEVEL, 0, SPECIES_BASCULEGION_F}),
    },
    ...
    [SPECIES_YAMASK_GALAR] =
    {
        ...
        .formSpeciesIdTable = sYamaskFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_RUNERIGUS}),
    },
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_KINGAMBIT}),
    #endif
    },
